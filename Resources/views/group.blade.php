	...
	<div class="row">
			...
			<div class="panel panel-default" ng-hide="group.selectSelected=='selected'">
				...
				<div class="panel-body">
					<div class="form-group col-sm-12">
						...
						<label class="col-sm-7 control-label"><a href ng-click="orderPermissionGroup()">Nome</a></label>
		...
		<div class="col-sm-6">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group col-sm-12">
						<div class="col-sm-1"><input type="checkbox" ng-model="selectedAllPermission" ng-click="checkAllPermission()" class="form-control" /></div>
						<div class="col-sm-3">
							Selecionar tudo
						</div>
						<div class="col-sm-1">
