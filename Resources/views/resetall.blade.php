							...
							<div class="panel-body">
								...
								<div ng-repeat="user in listUser | filter:user as resultUser">
									<div class="row">
										...
										<div class="col-sm-4"><a href ng-click="personDetails(user.contato)" data-toggle="modal" data-target="#modelPersonDetalhe">@{{user.Usuario}}</a></div>
										<div class="col-sm-4"><a href ng-click="personDetails(user.contato)" data-toggle="modal" data-target="#modelPersonDetalhe">@{{user.contato.Nome}}</a></div>
