...
app.controller('appPersonController', ['$scope', '$http', '$filter', 'Responsavel',function(scope, http, filter, Responsavel) {
...
*/
    //Variaveis relatório
	scope.qtdPage=_parceiro.per_page;
	scope._to=_parceiro.to;
	scope._from=_parceiro.from;
	scope._current_page=_parceiro.current_page;
	scope._last_page=_parceiro.last_page;
	scope._total=_parceiro.total;
	...
	scope.listPerson=_parceiro.data; //Pessoas
